...
describe("AlleryCardLevelTwo />", () => {
  ...
  it("render AllergyCardLevelTwo without dying", async () => {
    act(() => {
      ...
      wrapper = render(
        <BrowserRouter>
          <AllergyCardLevelTwo match={match} currentPatient={patient} />
        </BrowserRouter>
      );
    });
  ...
  it("should not display patients allergy when no allergy is documented ", async () => {
    act(() => {
      mockPerformPatientAllergySearch.mockResolvedValue({});
      wrapper = render(
        <BrowserRouter>
